 ...
 * @author duc
 */
public class ProcedureFormes_2 {
    ...
    public static void saisieParametresRectangle() {
        ...
        System.out.println("Entrez la largeur du trait : ");
    ...
    static void afficherRectangle() {
        ...
        System.out.println("\tlargeur du trait du rectangle = " + largeurTraitRectangle);
    }
    ...
    static void afficherCarre() {
        ...
        // Nouvelle instruction
        System.out.println("\tlargeur du trait du carré = " + largeurTraitCarre);
    }
    ...
    static void afficherCercle() {
        ...
        // Nouvelle instruction
        System.out.println("\tlargeur du trait du cercle = " + largeurTraitCercle);
    }
